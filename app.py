...
def apply_styles(is_dark):
    ...
    st.markdown(f"""
        ...
        .stMarkdown h4, .stMarkdown h5, .stMarkdown h6 {{ color: {text_color} !important; }}
...
if st.session_state.logged_in:
    ...
    st.markdown(
        "##### Real-Time AI Material Auditing & Carbon Mitigation Tracking System"
    )
    ...
    with tab_scan:
                ...
                with st.status("Initializing Neural Inference...",
                    ...
                    try:
                        ...
                        if annotated_img is not None:
                            st.image(
                                annotated_img,
                                caption=f"Detection Map  |  Inference: {inference_time} ms",
                                use_container_width=True
                            )

                        if results:
                            status.update(
                                label=(f"Scanning Complete: "
        ...
        with col_side:
            ...
            tips = [
                "Aluminum is 100% recyclable and can be back on the shelf "
                "in 60 days.",
                ...
                "Rinsing food containers before recycling prevents batch "
                "contamination.",
                "Steel is the world's most recycled material by total weight.",
                "Paper can be recycled up to 7 times before fibres degrade.",
            ]
...
# ==========================================
    ...
    with col_l:
        ...
        **Core Research Contributions:**
        ...
        """)
        st.info("💡 Please **Sign Up** (or **Log In**) via the sidebar to access the scanner.")
    with col_r:
        st.image(
